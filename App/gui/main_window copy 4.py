...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        start_btn.setFixedSize(100,90)
        config_btn.setFixedSize(100,90)
        exit_btn.setFixedSize(100,90)
    ...
    def on_start(self):
        ...
        for cam_id in range(1, 3):  # CAM 1과 CAM 2
            ...
            vw.vthread.event_triggered.connect(self.lightControl, type=Qt.QueuedConnection)
    ...
    def lightControl(self, event_time, cam_num, label, iou):
        ...
        if cam_num in self.reset_timers:
            ...
            QTimer.singleShot(0, old_timer.stop)  # ✅ 안전하게 스레드 위임
