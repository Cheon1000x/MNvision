...
def main():
    ...
    # 비교할 모델들 (경로 리스트)
    model_paths = [
        r"C:\Users\KDT-13\Desktop\Group 6_\MNvision\8.Pruning\ver0\model\pruning_model.pt",  # 원본 모델
        r"C:\Users\KDT-13\Desktop\Group 6_\MNvision\8.Pruning\ver1(기존학습코드로해서잘못됨_first_train)\runs\detect\train\weights\best.pt",  # 프루닝 모델 1
