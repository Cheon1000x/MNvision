...
"""
    ...
    def full_retrain_pipeline(self, epochs=30, batch_size=16, learning_rate=0.001, 
        ...
        try:
            # 1. 데이터셋 준비
            if not self.prepare_dataset(max_samples=1000):  # 메모리 절약을 위해 1000샘플로 제한
                return False
...
def main():
    ...
    # 설정 - 실제 경로로 수정하세요
    PRUNED_MODEL_PATH = r"C:\Users\KDT34\Desktop\Group6\expanded_pruned_model.pt"
    DATA_DIR = r"C:\Users\K\Desktop\Group_6\0602\data"  # 메인 데이터 폴더 (하위 폴더들 포함)
    CLASSES_FILE = r"C:\Users\KDT34\Desktop\Group6\classes.txt"
